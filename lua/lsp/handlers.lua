...
M.setup = function()
  ...
  -- Set up LspInfo command if it doesn't exist yet
  if vim.fn.exists(':LspInfo') == 0 then
    vim.api.nvim_create_user_command('LspInfo', function()
      require('vim.lsp.info').show_window()
    end, {})
  end
  
  -- Setup LspLog command for easier debugging
...
local function lsp_keymaps(bufnr)
  ...
  -- Add signature help in insert mode (backups the global mapping)
