-- Use the system-installed JDTLS
local function on_java_file()
  ...
  table.insert(try_paths, '/usr/share/java/jdtls')  -- Arch Linux system path
  ...
  local test_ok, java_test = pcall(require, "jdtls.dap")
  if test_ok then
    -- Add Java test bundles if DAP is used
    local bundles = {}
